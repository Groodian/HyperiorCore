    ...
    public void connect() {
        try {
            ...
            if (coreMySQL != null) {
                ...
                PreparedStatement ps01 = connection.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS core (UUID VARCHAR(100), playername VARCHAR(100), rank INT(100), level INT(100), coins INT(100), dailybonus VARCHAR(100), dailybonusvip VARCHAR(100))");
                ps01.executeUpdate();
                connection.finish();
            }
            ...
            if (dataMySQL != null) {
                ...
                PreparedStatement ps01 = connection.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS data (UUID VARCHAR(100), playername VARCHAR(100), logins INT(100), firstlogin VARCHAR(100), lastlogin VARCHAR(100), lastlogout VARCHAR(100), lastip VARCHAR(100), logindays INT(100), connectiontime BIGINT(100))");
                PreparedStatement ps02 = connection.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS ban (UUID VARCHAR(100), playername VARCHAR(100), ban VARCHAR(100), reason VARCHAR(100), history TEXT(99999), reports INT(100), reporthistory TEXT(99999))");
                ps01.executeUpdate();
                ps02.executeUpdate();
                connection.finish();
            }
            ...
            if (cosmeticMySQL != null) {
                ...
                PreparedStatement ps01 = connection.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS cosmetic (UUID VARCHAR(100), playername VARCHAR(100), cosmetics TEXT(99999), particle INT(100), block INT(100), helmet INT(100), chest_plate INT(100), pants INT(100), shoes INT(100), gadget INT(100))");
                ps01.executeUpdate();
                connection.finish();
            }
